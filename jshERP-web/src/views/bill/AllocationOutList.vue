  ...
  export default {
    ...
    data () {
      return {
        ...
        // 默认索引
        defDataIndex:['action','number','materialsList','anotherDepotName','operTimeStr','userName','materialCount','totalPrice','status'],
        // 默认列
        defColumns: [
          {
            title: '操作',
          ...
          { title: '调入仓库', dataIndex: 'anotherDepotName',width:145},
