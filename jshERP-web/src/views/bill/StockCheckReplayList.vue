        ...
        <a-col :md="24">
            <a-card :style="cardStyle" :bordered="false">
                ...
                <div class="table-operator" style="margin-top: 5px">
                    ...
                    <a-tooltip placement="left" title="盘点复盘的录入界面可以通过选择关联单据来加载信息。如果数量大于5，则显示差异较大，也可以输入实存进行修改。"
                        slot="action">
                ...
                <!-- table区域-end -->
                <!-- 表单区域 -->
                <stock-check-replay-modal ref="modalForm" @ok="modalFormOk" @close="modalFormClose"></stock-check-replay-modal>
...
<!--power by jishenghua-->
<script>
import StockCheckReplayModal from './modules/StockCheckReplayModal.vue'
...
import Vue from 'vue'
export default {
    name: "StockCheckReplayList",
    mixins: [JeecgListMixin, BillListMixin],
    components: {
        StockCheckReplayModal,
        BillDetail,
        JEllipsis,
        JDate
    },
