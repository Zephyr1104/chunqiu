  ...
  export default {
    ...
    data () {
      return {
        ...
        // 默认索引
        defDataIndex:['action','organName','number','materialsList','depotName','operTimeStr','userName','materialCount','totalPrice','totalTaxLastMoney',
        ...
        defColumns: [
          ...
          { title: '调入仓库', dataIndex: 'depotName',width:145},
          { title: '单据日期', dataIndex: 'operTimeStr',width:145},
          { title: '操作员', dataIndex: 'userName',width:80, ellipsis:true},
          { title: '数量', dataIndex: 'materialCount',width:60},
          { title: '金额合计', dataIndex: 'totalPrice',width:80,
            customRender:function (text,record,index) {
              return Math.abs(record.totalPrice);
            }
          },
