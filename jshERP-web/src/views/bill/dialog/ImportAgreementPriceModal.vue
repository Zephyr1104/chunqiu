    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="模板">
          <span><a href="/doc/agreement_price_template.xls" target="_blank"><b>采购协议价录入Excel模板[下载]</b></a></span>
        </a-form-item>
...
export default {
  name: "importAgreementPriceExcel",
  components: {
  },
  data() {
    return {
      ...
      url: {
        importExcelUrl: "/agreementPrice/importAgreementPriceExcel",
      }
    }
  },
  created() {
