  ...
  <a-row :gutter="24">
    <a-col :md="24">
      <a-card :style="cardStyle" :bordered="false">
        ...
        <!-- table区域-end -->
        <!-- 表单区域 -->
        <meal-modal ref="modalForm" @ok="modalFormOk"></meal-modal>
      </a-card>
    </a-col>
  </a-row>
</template>
<!-- BY cao_yu_li -->
<script>
  import MealModal from './modules/MealModal.vue'
    ...
    data () {
      return {
        ...
        columns: [
          ...
          {title: '餐次名称', dataIndex: 'name', width: 200},
        ...
        url: {
          list: "/meal/list",
          delete: "/meal/delete",
          deleteBatch: "/meal/deleteBatch",
          setDefault: "/meal/updateIsDefault",
          batchSetStatusUrl: "/meal/batchSetStatus"
        }
      }
    },
    computed: {
