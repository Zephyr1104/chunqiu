  ...
  export default {
    ...
    data () {
      return {
        ...
        columns: [
          ...
          {title: '餐次', dataIndex: 'mealName', width: 60, ellipsis:true},
    ...
    methods: {
      ...
      exportExcel() {
        ...
        let head = '单据编号,条码,名称,规格,餐次,单位,数量,单价,金额,调出仓库,调入仓库,调拨日期,备注'
        for (let i = 0; i < this.dataSource.length; i++) {
          ...
          item.push(ds.number, ds.barCode, ds.mname, ds.standard, ds.mealName, ds.mUnit, ds.operNumber,
            ds.unitPrice, ds.allPrice, ds.dname, ds.sname, ds.operTime, ds.newRemark)
          list.push(item)
        }
