    ...
    <a-col :md="24">
      <a-card :style="cardStyle" :bordered="false">
        ...
        <div class="table-operator"  style="margin-top: 5px">
          ...
          <a-tooltip placement="left" title="出库质检单主要处理一些质检部门提供的出库抽检报告单，便于成品出库抽检报告溯源以及应对上级主管部门检查等。" slot="action">
        ...
        <div>
          <a-table
            ...
            <span slot="action" slot-scope="text, record">
              <a @click="myHandleDetail(record, '出库抽检报告', prefixNo)">查看</a>
        ...
        <!-- table区域-end -->
        <!-- 表单区域 -->
        <finishR-modal ref="modalForm" @ok="modalFormOk" @close="modalFormClose"></finishR-modal>
      </a-card>
    </a-col>
  </a-row>
</template>
<script>
  import FinishRModal from './modules/FinishRModal'
    ...
    data () {
      return {
        ...
        columns: [
          ...
          { title: '报告日期 ', dataIndex: 'qualityTime', align:"center",width:80},
          { title: '商品编号', dataIndex: 'materialId', align:"center",width:160},
          { title: '商品名称', dataIndex: 'materialName', align:"center",width:80},
          { title: '数量', dataIndex: 'operNumber', align:"center",width:80},
