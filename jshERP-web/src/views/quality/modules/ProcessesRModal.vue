        ...
        <a-row class="form-row" :gutter="24">
          ...
          <a-col :lg="6" :md="12" :sm="24">
            <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="创建日期">
              <j-date v-decorator="['createTime', validatorRules.createTime ]" :show-time="true"/>
            </a-form-item>
          </a-col>
          <a-col :lg="6" :md="12" :sm="24">
            <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="报告编号">
              <a-input placeholder="请输入报告编号" v-decorator.trim="[ 'qualityNo' ]" :readOnly="true"/>
            </a-form-item>
          </a-col>
          <a-col :lg="6" :md="12" :sm="24">
            <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="操作人员">
              <a-select placeholder="选择操作人员" v-decorator="[ 'creator' ]"
                        :dropdownMatchSelectWidth="false" showSearch optionFilterProp="children">
    ...
    data () {
      return {
        ...
        accountTable: {
          ...
          dataSource: [],
          columns: [
            { title: '采购订单',key: 'inOutItemId',width: '20%', type: FormTypes.select, placeholder: '请选择${title}', options: [],
              allowSearch:true, validateRules: [{ required: true, message: '${title}不能为空' }]
            },
            { title: '报告名称',key: 'eachAmount', width: '10%', type: FormTypes.inputNumber, statistics: true, placeholder: '请选择${title}',
