    ...
    <a-col :md="24">
      <a-card :style="cardStyle" :bordered="false">
        ...
        <div class="table-operator"  style="margin-top: 5px">
          ...
          <a-tooltip placement="left" title="原料质检单主要处理一些供应商提供的原料质检报告单，便于食材原料报告溯源以及应对上级主管部门检查等。" slot="action">
        ...
        <div>
          <a-table
            ...
            <span slot="action" slot-scope="text, record">
              <a @click="myHandleDetail(record, '原料质检报告', prefixNo)">查看</a>
              <a-divider v-if="btnEnableList.indexOf(1)>-1" type="vertical" />
              <a v-if="btnEnableList.indexOf(1)>-1" @click="myHandleREdit(record)">编辑</a>
              <a-divider v-if="btnEnableList.indexOf(1)>-1" type="vertical" />
        ...
        <!-- table区域-end -->
        <!-- 表单区域 -->
        <materialR-modal ref="modalForm" @ok="modalFormOk" @close="modalFormClose"></materialR-modal>
        <bill-detail ref="modalDetail" @ok="modalFormOk" @close="modalFormClose"></bill-detail>
        <materialR-excel-iframe ref="billExcelIframe" @ok="modalFormOk" @close="modalFormClose"></materialR-excel-iframe>
      </a-card>
    </a-col>
  </a-row>
</template>
<script>
  import MaterialRModal from './modules/MaterialRModal'
    ...
    data () {
      return {
        ...
        columns: [
          ...
          { title: '供应商', dataIndex: 'organName', align:"center",width:140, ellipsis:true},
          ...
          { title: '商品条码', dataIndex: 'materialId', align:"center",width:160},
          { title: '商品名称', dataIndex: 'materialName', align:"center",width:160},
          { title: '检测数量', dataIndex: 'operNumber', align:"center",width:160},
