...
// 工厂模型
const queryProcessorTreeList = (params)=>getAction("/processor/getProcessorTree",params);
const getAllProcessorTreeByUser = (params)=>getAction("/processor/getAllProcessorTreeByUser",params);
const queryProcessorById = (params)=>getAction("/processor/findById",params);
const checkProcessor = (params)=>getAction("/processor/checkIsNameExist",params);
//经手人管理
...
//餐次信息
const getMealList = (params)=>getAction("/meal/getAllList",params);
const addMeal = (params)=>postAction("/meal/add",params);
const editMeal = (params)=>putAction("/meal/update",params);
const checkMeal = (params)=>getAction("/meal/checkIsNameExist",params);
//菜品类别
const getFoodCategoryList = (params)=>getAction("/foodCategory/getAllList",params);
const addFoodCategory = (params)=>postAction("/foodCategory/add",params);
const editFoodCategory = (params)=>putAction("/foodCategory/update",params);
const checkFoodCategory = (params)=>getAction("/foodCategory/checkIsNameExist",params);
//菜品名称
const getDishNameList = (params)=>getAction("/dishName/getAllList",params);
const addDishName = (params)=>postAction("/dishName/add",params);
const editDishName = (params)=>putAction("/dishName/update",params);
const checkDishName = (params)=>getAction("/dishName/checkIsNameExist",params);
//主BOM信息
const getBomMasterList = (params)=>getAction("/bomMaster/getAllList",params);
const addBomMaster = (params)=>postAction("/bomMaster/add",params);
const editBomMaster = (params)=>putAction("/bomMaster/update",params);
//子BOM信息
const getBomSlaveList = (params)=>getAction("/bomSlave/getAllList",params);
const addBomSlave = (params)=>postAction("/bomSlave/add",params);
const editBomSlave = (params)=>putAction("/bomSlave/update",params);
//套餐设置
const getDishPackageList = (params)=>getAction("/dishPackage/getAllList",params);
const addDishPackage = (params)=>postAction("/dishPackage/add",params);
const editDishPackage = (params)=>putAction("/dishPackage/update",params);
const checkDishPackage = (params)=>getAction("/dishPackage/checkIsNameExist",params);
//菜谱设置
const getDishMealRelList = (params)=>getAction("/dishMealRel/getAllList",params);
const addDishMealRel = (params)=>postAction("/dishMealRel/add",params);
const editDishMealRel = (params)=>putAction("/dishMealRel/update",params);
//菜谱分组
const getDishGroupList = (params)=>getAction("/dishGroup/getAllList",params);
const addDishGroup = (params)=>postAction("/dishGroup/add",params);
const editDishGroup = (params)=>putAction("/dishGroup/update",params);
const checkDishGroup = (params)=>getAction("/dishGroup/checkIsNameExist",params);

//菜谱信息
const getMenuList = (params)=>getAction("/menu/getMenuList",params);
const addMenu = (params)=>postAction("/menu/add",params);
//采购协议价信息
const addAgreementPrice = (params)=>postAction("/agreementPrice/add",params);
const editAgreementPrice = (params)=>putAction("/agreementPrice/update",params);
const checkAgreementPrice = (params)=>getAction("/agreementPrice/checkIsNameExist",params);
//营养成分信息
const addNutritional = (params)=>postAction("/nutritional/add",params);
const editNutritional = (params)=>putAction("/nutritional/update",params);
const checkNutritional = (params)=>getAction("/nutritional/checkIsNameExist",params);
//央厨信息
const addInformation = (params)=>postAction("/information/add",params);
const editInformation = (params)=>putAction("/information/update",params);
const checkInformation = (params)=>getAction("/information/checkIsNameExist",params);
const getInformationList = (params)=>getAction("/information/getAllList",params);
//自营餐厅
const addRestaurant= (params)=>postAction("/restaurant/add",params);
const editRestaurant = (params)=>putAction("/restaurant/update",params);
const checkRestaurant = (params)=>getAction("/restaurant/checkIsNameExist",params);
//能效设置
const addEnergy= (params)=>postAction("/energy/add",params);
const editEnergy = (params)=>putAction("/energy/update",params);
const checkEnergy = (params)=>getAction("/energy/checkIsNameExist",params);
//司机管理
const addDriver= (params)=>postAction("/driver/add",params);
const editDriver = (params)=>putAction("/driver/update",params);
//原料质检报告
const addMaterialR= (params)=>postAction("/materialR/add",params);
const editMaterialR = (params)=>putAction("/materialR/update",params);
const findMaterialRByNumber = (params)=>getAction("/materialR/getMaterialRByReportId",params);
//工序信息
const addProcessTemplate = (params)=>postAction("/processTemplate/add",params);
const editProcessTemplate = (params)=>putAction("/processTemplate/update",params);
const checkProcessTemplate = (params)=>getAction("/processTemplate/checkIsNameExist",params);
//商品属性
...
export {
  ...
  queryProcessorTreeList,
  getAllProcessorTreeByUser,
  queryProcessorById,
  checkProcessor,
